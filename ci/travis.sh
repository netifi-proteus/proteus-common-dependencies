...
if [ "$TRAVIS_PULL_REQUEST" != "false" ]; then
    ...
    ./gradlew clean build bintrayUpload publish--stacktrace --refresh-dependencies
else
    # Feature Branch
    echo -e 'Build Branch => Branch ['$TRAVIS_BRANCH']'
    ./gradlew clean generatePomFileForMavenBomPublication artifactoryPublish publish --stacktrace --refresh-dependencies
fi
